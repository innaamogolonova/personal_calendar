...
export function EntityEditPopover({
  ...
  return (
    <div className="absolute inset-0 z-20 flex items-center justify-center bg-black/20 p-4">
      <div className="w-full max-w-sm rounded-lg border border-neutral-200 bg-white p-4 shadow-xl">
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-2 pt-1">
            ...
            <button
              ...
              className="ml-auto rounded-md border border-red-200 px-3 py-2 text-sm font-medium text-red-600 hover:bg-red-50"
            >
              Delete
            </button>
          </div>
